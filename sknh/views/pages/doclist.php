    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <!--<table id="table" data-toggle="table" data-url="action.php?action=get_bd"  
                ...
                <table id="table" data-toggle="table" data-url="action.php?action=doc_list"  
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-field="doc_reg" data-halign="center" data-align="center">Dr. Reg. No.</th>
                            <th data-field="doc_name" data-halign="center" data-align="center">Dr. Name</th>
                            <th data-field="contact_no" data-halign="center" data-align="center">Dr. Contacts</th>
                            <th data-field="doct_quli" data-halign="center" data-align="center">Dr. Qualification</th>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.status_checks', function () {
        ...
        if (confirm("Are you sure to " + msg)) {
            ...
            $.ajax({
                ...
                {
                    //location.reload();
                    window.location.href = 'index.php?pg=doclist';
                }
            });
        }
    });
    $(document).on('click', '.status_delete', function () {
        ...
        if (confirm("Are you sure to delete this record ?")) {
            $.ajax({method: "POST", url: "action.php?action=del_doc", data: {id: data_val}, success: function (result) {
                    window.location.href = 'index.php?pg=doclist';
                }});
        }
    });
