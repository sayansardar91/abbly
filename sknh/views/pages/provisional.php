...
<div class="row" >
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading" >Add New Provisional Diagnosis</div>
            <div class="panel-body">
                <div class="row">
                    <form class="form-horizontal" role="form" action="action.php?action=add_prov" method="post">
                    	<input type="hidden" name="id" id="id" value=""/>
                        <div class="form-group">
                           <label for="inputType" class="col-sm-2 control-label">Diagnosis Name</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" id="diog_name" name="diog_name" placeholder="Provisional Diagnosis">
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Provisional Diagnosis List</div>
                            <div class="panel-body">
                                <table id="table" data-toggle="table" data-url="action.php?action=get_prov"  
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-field="diog_name" data-halign="center" data-align="center" >Provisional Diagnosis</th>
