        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form class="form-horizontal" role="form" action="action.php?action=add_dept" method="post">
                        <div class="form-group">
                            <label for="inputType" class="col-sm-2 control-label">Department Name</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control" id="dept_name" name="dept_name" placeholder="Input Department Name">
                            </div>
                            <div class="col-sm-4">
                                <button type="submit" class="btn btn-primary" name="submit">Add Department</button>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">Departments Table</div>
                            <div class="panel-body">
                                <table id="table" data-toggle="table" data-url="action.php?action=get_dpt"  
    ...
    $(document).on('click', '.status_checks', function () {
        ...
        if (confirm("Are you sure to " + msg)) {
            ...
            $.ajax({
                ...
                {
                    //location.reload();
                    window.location.href = 'index.php?pg=departments';
                }
            });
        }
    });
