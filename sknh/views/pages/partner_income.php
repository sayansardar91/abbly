    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="doct_form" action="reports/income_report.php" method="post" target="_blank">
                   <input type="hidden" name="rptType" id="rptType" value="2"/>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <label class="control-label">Income Report By Date : </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <label class="control-label">Income Report By Month : </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="col-sm-6">
                                <div class="form-group text-center">
                                    <label class="control-label">Income Report By Financial Year : </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
