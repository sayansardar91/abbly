    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-horizontal" id="doct_form" action="reports/expense_report.php" method="post" target="_blank">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <label class="control-label">Expense Report By Date : </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="col-sm-5">
                                <div class="form-group text-center">
                                    <label class="control-label">Expense Report By Month : </label>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="col-sm-6">
                                <div class="form-group text-center">
                                    <label class="control-label">Expense Report By Financial Year : </label>
                                </div>
                            </div>
                            <div class="col-sm-3">
                                <div class="form-group">
