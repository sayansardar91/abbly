...
<script>$(function () {
        ...
        $('a.add-doc').click(function (event) {
            ...
            var newRow =
                    '<tr>' +
                    '<td><input type="text" name="doc_name[]" style="margin-bottom: 5px" class="form-control"/></td>' +
                    ...
                    switch (value) {
                        case '1':
                            for (var i = 0, len = data['doc_name'].length; i < len; i++) {
                                newRow +=
                                        '<tr class="docOld">' +
                                        '<td><input type="text" value="' + $.trim(data['doc_name'][i]) + '" name="doc_name[]" style="margin-bottom: 5px" class="form-control"/></td>' +
